...
// Deprecated: Use LogName.ProtoReflect.Descriptor instead.
func (*LogName) Descriptor() ([]byte, []int) {
	return file_proto_model_proto_rawDescGZIP(), []int{0}
}

func (x *LogName) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
var file_proto_model_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x03, 0x61, 0x70, 0x69, 0x22, 0x31, 0x0a, 0x07, 0x4c, 0x6f, 0x67, 0x4e,
	...
	0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x42, 0x17, 0x5a, 0x15, 0x67,
