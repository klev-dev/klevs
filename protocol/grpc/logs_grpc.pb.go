...
const (
	Logs_List_FullMethodName   = "/grpc.Logs/List"
	Logs_Create_FullMethodName = "/grpc.Logs/Create"
	Logs_Delete_FullMethodName = "/grpc.Logs/Delete"
)
...
var Logs_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "protocol/grpc/logs.proto",
}
